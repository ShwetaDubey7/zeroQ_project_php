...
<div class="relative min-h-screen flex items-center justify-center p-4">
    ...
    <div class="relative w-full max-w-md mx-auto">
        <div class="text-center mb-8">
            ...
            <p class="text-xl text-light/70 mt-2">Create a Business Account</p>
        </div>
        ...
        <div class="backdrop-blur-xl bg-light/5 rounded-2xl border border-light/10 shadow-2xl glow p-8">
            ...
            <form action="../actions/handle_register.php" method="POST" class="space-y-6">
                 <div>
                    ...
                    <input type="text" name="business_name" id="business_name" required class="w-full bg-dark/50 border-2 border-accent/20 rounded-xl px-4 py-3 placeholder-light/30 focus:border-accent focus:ring-1 focus:ring-accent transition-all">
                </div>
                <div>
         ...
         <p class="mt-8 text-center text-sm text-light/50">
            Already have an account? <a href="login.php" class="font-semibold text-accent hover:underline">Login here</a>.
        </p>
    </div>
</div>
